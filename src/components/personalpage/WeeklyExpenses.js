        ...
        return (
            ...
            <div className="row row-content shadow-lg  mb-3 bg-white rounded">
                <div className="col-12">
                    <h2 className="text-center bg-warning text-light shadow-lg mb-3 rounded">WEEKLY EXPENSES</h2>
                        ...
                        <div className="">
                            ...
                            <Table hover className="bg-light mt-2 rounded  ">
                                <thead>
                                    ...
                                    <tr>
                                        <th>Total</th>
                                        <td className="shadow-lg  mb-2 bg-white rounded "> = $  {this.state.weekly}</td>
                                    </tr>
                                </thead>
                            </Table>
                        </div>
